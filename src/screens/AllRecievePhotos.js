...
function AllRecievePhotos(props) {
  ...
  return (
    <SafeAreaView style={{ backgroundColor: "#fff", flex: 1 }}>
      <Header title="All Recieved Albums" goBack={false} style={{ backgroundColor: colors.light }} />
...
// export default Home
export default connect(mapStateToProps, mapDispatchToProps)(AllRecievePhotos);
